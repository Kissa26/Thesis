...
class CategoriiModel:
    ...
    def assemble_full_model(self, width, height, num_categories):
        ...
        # Output layer
        categories_output = Dense(num_categories, activation='softmax', name='categories')(x)
